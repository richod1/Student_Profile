...
const {resetPasswordHTML}=require('../email/template/userEmailForgetPasswordHTML')

// signup controller
const signup=async(req,res,next)=>{
    const {name,email,phone,password,programme,course}=req.body;
